...
function ComandesList() {
  ...
  const fetchOrders = async () => {
    const res = await fetch(`${API_URL}/comandes`, { headers });
  ...
  const fetchProveidors = async () => {
    const res = await fetch(`${API_URL}/proveidors`, { headers });
    const json = await res.json();
    setProveidors(json.dades || []);
  };

  const fetchProducts = async () => {
    const res = await fetch(`${API_URL}/productes`, { headers });
    const json = await res.json();
